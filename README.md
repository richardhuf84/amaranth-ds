...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/EHF4Wzp7pW)
...
```sh
npx nx serve amaranth-ds
```

To create a production bundle:

```sh
npx nx build amaranth-ds
```

To see all available targets to run for a project, run:

```sh
npx nx show project amaranth-ds
```
